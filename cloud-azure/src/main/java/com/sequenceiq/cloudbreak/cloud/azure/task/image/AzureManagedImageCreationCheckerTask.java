...
public class AzureManagedImageCreationCheckerTask extends PollBooleanStateTask {
    ...
    protected Boolean doCall() {
        LOGGER.info("Waiting for managed image to be created: {}", context.getAzureImageDetails().getImageName());
    ...
    private Optional<VirtualMachineCustomImage> findVirtualMachineCustomImage() {
        return azureManagedImageService.findVirtualMachineCustomImage(context.getAzureImageDetails(), context.getAzureClient());
    }
}

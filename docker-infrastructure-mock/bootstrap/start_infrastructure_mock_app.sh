...
echo "Starting the Infrastructure mock application..."
...
eval "(java $CB_JAVA_OPTS -jar /infrastructure-mock.jar) & JAVAPID=\$!; trap \"kill \$JAVAPID; wait \$JAVAPID\" SIGINT SIGTERM; wait \$JAVAPID"
